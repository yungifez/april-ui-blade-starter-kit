                        ...
                        <april:sidebar-group-content>
                            <april:sidebar-menu>
                                <april:sidebar-menu-item>
                                    <april:sidebar-menu-button-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                    ...
                    <april:sidebar-group>
                        ...
                        <april:sidebar-group-content>
                            <april:sidebar-menu>
                                ...
                                <april:sidebar-menu-item>
                                    <april:sidebar-menu-button-link href="{{ route('security.edit') }}" :active="request()->routeIs('security.edit')">
                                        <x-lucide-lock-keyhole class="size-4" />
                                        <span>Security</span>
                                    </april:sidebar-menu-button-link>
                                </april:sidebar-menu-item>
                                <april:sidebar-menu-item>
                                    <april:sidebar-menu-button-link href="{{ route('appearance.edit') }}" :active="request()->routeIs('appearance.edit')">
